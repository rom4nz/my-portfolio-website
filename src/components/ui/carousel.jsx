import { RiArrowRightLongLine, RiGithubFill } from "@remixicon/react";
...
const Slide = ({
    ...
    const { src, title, text, technologies = [] } = slide;
    ...
    return (
        <div className="[perspective:1200px] [transform-style:preserve-3d]">
            <li
                ...
                {/* Technologies row - top right corner of card */}
                {technologies.length > 0 && (
                    <div className="absolute top-4 right-4 z-30 flex flex-row gap-2 bg-transparent">
                ...
                <article
                    ...
                    <div className="flex justify-center">
                        <button
                            className="mt-6 hover:bg-white/80 px-3 py-1.5 w-fit mx-auto sm:text-sm text-black bg-white h-12 border border-transparent text-xs flex justify-center items-center rounded-2xl hover:shadow-lg transition duration-200 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
                            <a href={slide.link} target="_blank" rel="noopener noreferrer" className="flex gap-2 items-center">
                                <RiGithubFill />
                                <h2 className="text-sm font-bold">GitHub Link</h2>
                            </a>
                        </button>
                    </div>
                </article>
...
const CarouselControl = ({
    ...
    return (
        <button
            ...
            title={title}
            onClick={handleClick}>
            <RiArrowRightLongLine className="text-neutral-600 dark:text-neutral-200" />
        </button>
    );
};
